...
export function showHelp() {
  ...
  )}: The language for AI responses (e.g., pt-BR, en-US).`;
  ...
  ${chalk.cyan("acr help")}                     Displays this detailed help.`;
  ...
  - Use ${chalk.cyan(
    "acr set_config"
  )} to set your preferences before using the tool.
  - Ensure your API key (${chalk.yellow("OPENAI_API_KEY")}) is kept secure.
