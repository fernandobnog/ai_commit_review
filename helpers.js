...
export function showHelp() {
  return `
${chalk.bold("Usage:")}
  ${chalk.cyan("acr <COMMIT_SHA> [commands]")}
...
${chalk.bold("Commands:")}
  ${chalk.cyan("acr <COMMIT_SHA>")}        Analyzes a specific commit.
  ${chalk.cyan(
    "acr set_config"
  )}          Updates configurations (e.g., OPENAI_API_KEY, OPENAI_API_MODEL, OPENAI_RESPONSE_LANGUAGE).

${chalk.bold("Examples:")}
  ${chalk.cyan("acr 123456")}              Analyzes the commit with SHA 123456.
  ${chalk.cyan("acr set_config OPENAI_API_KEY=your-key")}
  ${chalk.cyan("acr set_config OPENAI_API_MODEL=gpt-4")}
  ${chalk.cyan("acr set_config OPENAI_RESPONSE_LANGUAGE=Spanish")}
  `;
}
